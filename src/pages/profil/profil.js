...
import { FaFacebook, FaLinkedin, FaUserCircle } from "react-icons/fa";
...
export default function Profil() {
  ...
  const getUtilisateurByid = async () => {
    const response = await fetchWrapper.get(
      `https://astrainingbusiness-crud.onrender.com/api/users/voir/${id}`
    );
        ...
        <div>
          ...
          {user.estTeste == false ? (
            ...
            >
              ...
              >
                l'utilisateur n'a pas encore passé le test{" "}
              </p>
              <button
                onClick={() => setChoi(false)}
                style={{
                  cursor: "pointer",
                  width: "150px",
                  height: "35px",
      ...
      <div className="corps">
        <div style={{ position: "relative", top: "52px" }}>
          {/* <img
            ...
            /> */}
          <FaUserCircle size={100} className="faUser" color={'gray'} />
        </div>
        <div className="compte">
          ...
          <div style={{ display: "contents" }}>
            {user == null ? (
              ...
              />
            ) : user._id == authUser.user.user._id ? (
              <button
          ...
          <div className="contenu">
            {user == null ? (
              ...
              user._id == authUser.user.user._id && (
                <button
                  ...
                  onClick={() => navigate("/MotdepasseChange")}
                >
            ...
            <button
              ...
              onClick={() => navigate(`/modifie_informations/${user._id}`)}
            >
