...
export default function Pe() {
  ...
  const methods = useForm({
    defaultValues: async () =>
      await fetchWrapper.get(
        `https://astrainingbusiness-crud.onrender.com/api/presententrepreneur/voir/${id}`
      ),
  });
  ...
  const onSubmit = async (d) => {
    const response = await fetchWrapper.post(
      "https://astrainingbusiness-crud.onrender.com/api/presententrepreneur/modifie",
      d
    );
    /*if(response){
      ...
      <div className="HautBp">
        <div>
          ...
          >
            ...
            <li style={{ margin: "10px" }}>
              <a href="#csudo">
                CURSUS SCOLAIRE-UNIVERSITAIRE ET DIPLOMES OBTENUS
              </a>
            </li>
                    ...
                    <div class="promoteur">
                      <ol type="1">
                        ...
                        <div class="presntation" style={{ width: "1000px" }}>
                          ...
                          <div class="photo">
                            {/*<Controller
                             render={({field})=><input    type="image" src={photoLo} alt="PHOTO" style={{border:"none"}}/>*/}
                          </div>
                        </div>

                        <h4>
                          <u id="dc">DOMAINES DES COMPETENCES</u>
                        </h4>
                        ...
                        <h4>
                          <u id="ep">EXPERIENCES PROFESSIONNELLES</u>
                          <i> (à énumerer)</i>
                        </h4>
                        <br />
