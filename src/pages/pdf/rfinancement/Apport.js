      ...
      <View style={styles.section}>
        ...
        <View style={styles.sousSection}>
          <Text style={{ fontSize: "16px", textAlign: "center", color: "red" }}>
            Recherche financement - Apport familial{" "}
          </Text>
        </View>

        <View style={styles.sousSection}>
          <Text>
            A combien de personnes comptez-vous ou avez-vous contacté au sein de
            la famille ou de vos connaissances proches pour le financement de
            votre projet?
          </Text>
          <Text>{data?.nombre_personne_contact}</Text>
        </View>
          ...
          <View style={styles.sousSection}>
            <View style={styles.table}>
              <View style={styles.tableRow}>
                ...
                >
                  <Text style={styles.tableCell}>
                    Combien comptez vous lui demander?
                  </Text>
                </View>
                <View
                  style={{
                ...
                >
                  <Text style={styles.tableCell}>
                    Quand compte-t-elle vous apporter son soutien?
                  </Text>
                </View>
                <View
                  style={{
        ...
        <View style={styles.sousSection}>
          <Text>
            Montant total recolté auprés de la famille ou des connaissance
            proches
          </Text>
          <Text>{data?.montant_recolte}</Text>
        </View>
        <View style={styles.sousSection}>
          <Text
...
export default function Apportpdf() {
  ...
  const datating = async () => {
    const reponses = await fetchWrapper.get(
      `https://astrainingbusiness-crud.onrender.com/api/apport/voir/${id}`
    );
    if (reponses) {
      setData(reponses);
